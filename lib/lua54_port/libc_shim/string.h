/* lib/lua54_port/libc_shim/string.h — supplement kernel string.h with missing functions
 *
 * Include order in LUA_CFLAGS: -Ilib/lua54_port/libc_shim is placed BEFORE -Iinclude,
