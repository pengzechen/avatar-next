/* lib/lua54/compat/stdlib.h — freestanding stdlib stubs for Lua */
#ifndef _COMPAT_STDLIB_H
#define _COMPAT_STDLIB_H

#include <stddef.h>   /* size_t */

/* Memory allocation — implemented in lib/lua_platform.c */
void *malloc(size_t size);
void  free(void *ptr);
void *realloc(void *ptr, size_t size);

/* Number conversion — implemented in lib/lua54/compat/lua_math_impl.c */
