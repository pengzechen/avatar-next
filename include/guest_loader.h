 ...
 *   0x70080000             kernel Image（ARM64 raw Image，text_offset=0）
 *   0x73600000             DTB（4 KiB 内）
 *   0x73800000             initrd
 */
...
#define GUEST_LINUX_KERNEL_GPA 0x70080000ULL
#define GUEST_LINUX_DTB_GPA    0x73600000ULL
#define GUEST_LINUX_INITRD_GPA 0x73800000ULL
